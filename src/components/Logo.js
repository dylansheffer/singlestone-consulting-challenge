...
export const Logo = ({className, ...props}) => (
  // Using inline SVG, so we have finer control with CSS and Javascript
  <svg {...props} role="img" className="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 358.3 52.1">
